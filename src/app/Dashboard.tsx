...
export default function Dashboard({ tasks, memories, cronJobs }: DashboardProps) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 text-[#666]">
                ...
                <span className="text-sm">8 ACP</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === "overview" && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <StatCard label="WALLET" value="0.004 ETH" subValue="Base" color="#00FFF5" />
                <StatCard label="ACP SERVICES" value="8" subValue="Active" color="#FFE600" />
                <StatCard label="ROGER TOKEN" value="$ROGER" subValue="0x17b9..." color="#FF2E63" />
          ...
          {activeTab === "tasks" && (
            <motion.div 
              ...
              className="space-y-4"
            >
              <h2 className="text-2xl font-bold">Alle Tasks ({tasks.length})</h2>
              {tasks.map((task, i) => (
                <TaskCard key={i} {...task} />
              ))}
            </motion.div>
          ...
          {activeTab === "stats" && (
            ...
            >
              ...
              <StatCard label="ACP SERVICES" value="8" subValue="Active" color="#FFE600" />
              <StatCard label="ROGER TOKEN" value="$ROGER" subValue="0x17b9..." color="#FF2E63" />
              <StatCard label="TASKS" value={String(tasks.length)} subValue="Open" color="#00FFF5" />
              <StatCard label="MEMORIES" value={String(memories.length)} subValue="Recent" color="#FFE600" />
              <StatCard label="CRON JOBS" value={String(cronJobs.length)} subValue="Active" color="#00FF88" />
            </motion.div>
          )}
